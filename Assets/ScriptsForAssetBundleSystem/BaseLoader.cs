...
public class BaseLoader : MonoBehaviour {
	...
	//	DontDestroyOnLoad(gameObject);
		...
		AssetBundleManager.BaseDownloadingURL = relativePath + "/";
...
//			return "file://" +  System.Environment.CurrentDirectory.Replace("\\", "/"); // Use the build output folder directly.
			return Global.ThreeUnitySavePath + @"extract";
		else if (Application.isWebPlayer)
			return System.IO.Path.GetDirectoryName(Application.absoluteURL).Replace("\\", "/")+ "/StreamingAssets";
		else if (Application.isMobilePlatform || Application.isConsolePlatform)
		//	return Application.streamingAssetsPath;
			return "file://" +
				Global.ThreeUnitySavePath + @"extract";
	...
	public void MyLoadAsset (string assetBundleName, string assetName)
	{
		...
		if (prefab != null) {
			Debug.Log ("Intializing 3dmodels.......");
			Global.goCharacter = GameObject.Instantiate (prefab);
			Global.bLoadedPackage = true;
			Debug.Log("unity3d instantiate finish " + System.DateTime.Now.ToString("HH-mm-ss-fff"));
		}
